...
public interface DepotHeadMapperEx {
    List<DepotHeadVo4List> selectByConditionDepotHead(
            ...
            @Param("id") Integer id);
    List<DepotHeadVo4List> exportDepotItemSupplierExcel(
            @Param("type") String type,
            @Param("subType") String subType,
            @Param("id") Integer id);
    ...
    List<Material> findMaterialsListByHeaderMsg(@Param("id") Long id);
    ...
    List<DepotHeadQuarter> getSaleByYear(
            @Param("type") String type,
            @Param("subType") String subType,
            @Param("tenantId") Long tenantId,
