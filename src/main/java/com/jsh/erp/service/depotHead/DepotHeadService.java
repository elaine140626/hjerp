...
//                    dh.setOthermoneyitem(otherMoneyItemStr);
    ...
    public void updateDepotHeadAndDetail(Long id, String beanJson, String inserted, String deleted, String updated,
        ...
        depotItem.setId(id);
        if ( depotHead.getMyuploadFile() != null && depotHead.getMyuploadFile()!="" && !depotHead.getMyuploadFile().equals("") ){
            depotItem.setContractEnclosure("是");
        }
        if (depotHead.getMyuploadFiles() != null && depotHead.getMyuploadFiles()!="" && !depotHead.getMyuploadFiles().equals("") ){
    ...
    public DepotHeadOrder getOrderByYear(String type, String subType, Long tenantId, String beginTime, String endTime) {
        return depotHeadMapperEx.getOrderByYear(type, subType, tenantId, beginTime, endTime);
    }
