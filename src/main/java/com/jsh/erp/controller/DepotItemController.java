        ...
        try {
            ...
            if (null != dataList) {
                for (DepotItemVo4WithInfoEx diEx : dataList) {
                    ...
                    objs[2] = getUName(diEx.getMaterialUnit(), diEx.getUName());
        ...
        try {
            ...
            if (null != dataList) {
                for (DepotItemStockWarningCount diEx : dataList) {
                    ...
                    objs[4] = diEx.getBasicInNumber().setScale(0,BigDecimal.ROUND_DOWN).toString();
                    objs[5] = diEx.getBasicOutNumber() == null ? "0" : diEx.getBasicOutNumber().setScale(0,BigDecimal.ROUND_DOWN).toString();
                    objs[6] = diEx.getBasicNumber() == null ? "0" : diEx.getBasicNumber().setScale(0,BigDecimal.ROUND_DOWN).toString();
                    objs[7] = diEx.getSafetystock() == null ? "0" : diEx.getSafetystock().setScale(0,BigDecimal.ROUND_DOWN).toString();
                    objs[8] = diEx.getBasicLinjieNumber() == null ? "0" : diEx.getBasicLinjieNumber().setScale(0,BigDecimal.ROUND_DOWN).toString();
                    objects.add(objs);
                }
            }
