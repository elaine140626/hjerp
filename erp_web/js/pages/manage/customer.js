    ...
    function initTableData() {
        ...
        $('#tableData').datagrid({
            ...
            columns:[[
                ...
                { title: '所悟公司/参见单位', field: 'project_name',width:50,align:"center"},
                { title: '微信号', field: 'wx',width:50,align:"center"},
                { title: '项目地址', field: 'project_address',width:50,align:"center"},
                { title: '身份证识别器', field: 'card_recognizer',width:50,align:"center"},
                { title: '读卡器编号', field: 'reader_number',width:50,align:"center"},
                { title: '合同', field: 'contract',width:50,align:"center"},
                { title: '合同编号', field: 'contract_nabnum',width:50,align:"center"},
                { title: '合同金额', field: 'contacts',width:50,align:"center"},
                { title: '付款', field: 'contacts',width:50,align:"center"},
                { title: '发票', field: 'contacts',width:50,align:"center"},
                { title: '安装', field: 'contacts',width:50,align:"center"},
                { title: '安装人', field: 'contacts',width:50,align:"centeign:"center"},
                { title: '电子邮箱',field: 'email',width:80,r"},
                { title: '手机号码', field: 'telephone',width:100,alalign:"center"},
                { title: '客户类别', field: 'fax',width:100,align:"center"},
